...
const ACTION_COLORS: Record<string, string> = {
  ...
  AUTO_EXTRACT:  'bg-purple-50 text-purple-700',
  UPDATE_FIELD:  'bg-amber-50 text-amber-700',
  VALIDATE_DOC:  'bg-green-50 text-green-700',
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Full history of all actions across your documents.</p>
      </div>
